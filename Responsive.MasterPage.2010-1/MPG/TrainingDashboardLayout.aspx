...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	<div class="container-fluid">
        <div class="row">
    	    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 webpartcontainer">
    		    <WebPartPages:WebPartZone runat="server" Title="R1C1" ID="WPZR1C1"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
    	    </div>
    	    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-4 webpartcontainer">
        ...
        <div class="row">
		    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 webpartcontainer">
